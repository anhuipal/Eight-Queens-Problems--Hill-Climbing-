...
public class ChessBoard {
    ...
    /**
     * Core method of the problem combines all the method nessecery to find a solution and it runs until the @param globlac conflicts are 0
     */
    ...
    public void findSolution(){
        ...
        do{
            for(int i = 1;i<=8;i++){
                this.moveQueen(columnStart,step);
                columnStart = step + 1;
                step +=8;
            }
            ...
            this.calculateConflicts();
            //this.printQueenPlaces(); Uncomment this line to see intermidiate steps
    ...
    public void moveQueen(int columnStart,int step){
